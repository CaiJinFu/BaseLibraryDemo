package com.example.baselibrarydemo.utils

import android.accounts.NetworkErrorException
import androidx.annotation.StringRes
import com.example.baselibrary.utils.ToastUtil
import com.example.baselibrarydemo.BaseApplication
import com.example.baselibrarydemo.R
...
object ExceptionUtil {
    ...
    private fun showToast(errorMsg: String, errorCode: Int = -1) {
        if (errorCode == -1) {
            ...
            ToastUtil.toast("$errorCode：$errorMsg")
        }
    }
